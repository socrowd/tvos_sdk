#
#  Be sure to run `pod spec lint SoCrowd.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Aurel"
  # s.authors            = { "Aurel" => "aurel@socrowd.tv" }
  # s.social_media_url   = "http://twitter.com/Aurel"
